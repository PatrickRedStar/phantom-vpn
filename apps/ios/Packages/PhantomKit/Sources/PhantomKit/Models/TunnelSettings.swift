...
public struct TunnelSettings: Codable {
    ...
    public init(
        ...
        self.manualDirectIpv6Cidrs = RoutePolicySnapshot.normalizedIPv6Cidrs(
            from: manualDirectIpv6Cidrs.joined(separator: "\n")
        ).valid
    ...
    public init(from decoder: Decoder) throws {
        ...
        let ipv6Cidrs = try container.decodeIfPresent([String].self, forKey: .manualDirectIpv6Cidrs) ?? []
        manualDirectIpv6Cidrs = RoutePolicySnapshot.normalizedIPv6Cidrs(
