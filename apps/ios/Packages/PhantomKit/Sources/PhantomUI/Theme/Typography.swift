...
public enum GsFontName {
    ...
    public static let spaceGrotesk           = "SpaceGrotesk-Regular"
    public static let spaceGroteskMedium     = "SpaceGrotesk-Medium"
    public static let spaceGroteskBold       = "SpaceGrotesk-Bold"
...
public struct GsFontSpec {
    ...
    public init(name: String, size: CGFloat, letterSpacingEm: CGFloat = 0, lineHeight: CGFloat? = nil) {
        self.name = name
        self.size = size
    ...
    public var trackingPoints: CGFloat { letterSpacingEm * size }
...
extension Text {
    ...
    public func gsFont(_ style: GsFont) -> some View {
        let s = style.spec
        return self
...
public enum Typography {
    ...
    public static let brand         = GsFont.brand.spec.font
    public static let specTitle     = GsFont.specTitle.spec.font
    public static let stateHeadline = GsFont.stateHeadline.spec.font
    public static let profileName   = GsFont.profileName.spec.font
    public static let clientName    = GsFont.clientName.spec.font
    public static let statValue     = GsFont.statValue.spec.font
    public static let hint          = GsFont.hint.spec.font

    // GsText — Departure Mono
    public static let labelMono      = GsFont.labelMono.spec.font
    public static let labelMonoSmall = GsFont.labelMonoSmall.spec.font
    public static let labelMonoTiny  = GsFont.labelMonoTiny.spec.font
    public static let hdrMeta        = GsFont.hdrMeta.spec.font
    public static let ticker         = GsFont.ticker.spec.font
    public static let valueMono      = GsFont.valueMono.spec.font
    public static let chipText       = GsFont.chipText.spec.font
    public static let navItem        = GsFont.navItem.spec.font
    public static let fabText        = GsFont.fabText.spec.font

    // GsText — JetBrains Mono
    public static let body       = GsFont.body.spec.font
    public static let bodyMedium = GsFont.bodyMedium.spec.font
    public static let kvValue    = GsFont.kvValue.spec.font
    public static let host       = GsFont.host.spec.font
    public static let logTs      = GsFont.logTs.spec.font
    public static let logLevel   = GsFont.logLevel.spec.font
    public static let logMsg     = GsFont.logMsg.spec.font

    // GsTypography — Material baseline
    public static let bodyLarge   = GsFont.bodyLarge.spec.font
    public static let bodySmall   = GsFont.bodySmall.spec.font
    public static let titleLarge  = GsFont.titleLarge.spec.font
    public static let titleMedium = GsFont.titleMedium.spec.font
    public static let titleSmall  = GsFont.titleSmall.spec.font
    public static let labelLarge  = GsFont.labelLarge.spec.font
    public static let labelMedium = GsFont.labelMedium.spec.font
    public static let labelSmall  = GsFont.labelSmall.spec.font
}
